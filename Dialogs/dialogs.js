...
>
    <div className="modal-content dark" role="dialog"
        aria-labelledby="dialogTitle" aria-describedby="dialogDesc" aria-live="polite">
        ...
        <div className="modal-footer">
            <button className="btn btn-secondary dark" onClick={() => { this.setState({ open: false }); }}>CANCEL</button>
